...
%%% Inizio codice
%
set(App,'String','14'); % Valore da reperire nel file Plotter.m
set(E,'String','Stop & Wait: n=f(a)');
...
set(P,'Visible','on');
set(PP,'Visible','on');
set(P,'Position',[.13 .92 .055 .025]);
set(PP,'Position',[.19 .915 .055 .025]);
set(Tau,'Visible','off');
